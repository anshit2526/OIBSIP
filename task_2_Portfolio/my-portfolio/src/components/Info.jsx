    ...
    <div className='p-10'>
      ...
      <div className="container overflow-y-scroll max-h-[63dvh] my-scrollbar">
        <div id="about">
          ...
          <p className='font-light mx-5 mt-2'> I honed my skills in both front-end and back-end development, employing best practices to create high-performing and user-centric UI/UX experiences. Recognizing the critical role of soft skills, I actively focused on developing strong communication skills, including fluency in English, and maintaining a positive and professional demeanor. My dedication to self-improvement extends to stress management, problem-solving, and critical thinking, fostered by my interest in psychology. Additionally, I enjoy playing chess and video games, which hone my strategic thinking, quick thinking, and problem-solving abilities. </p>
          <p className='font-light mx-5 mt-2'> I'm a continuous learner, leveraging various resources like official documentation, online tutorials, coding platforms, and AI tools like ChatGPT and Gemini, to stay abreast of the latest advancements and develop the most effective solutions for your website needs.</p>
          <p className='font-light mx-5 mt-2'> I am confident I can be a valuable asset to your team. My expertise in various web development tools ensures a seamless and efficient experience for your business. I am dedicated to using my skills to elevate your brand's online presence and drive profitability through website optimization strategies.</p>
          <p className='font-light mx-5 mt-2'> Driven by my curiosity for the future and a growth mindset informed by past experiences, I am adaptable and thrive in diverse work environments and projects. While I possess the ability to work independently, I also value the collaborative spirit and positive impact of strong team environments.</p>
        </div>

        <div id="journey">
        <h3 className='text-4xl mt-10 mb-3 text-my-theme w-max'><a href="#journey">My Journey</a></h3>
        <p className="font-light mx-5">My passion for web development blossomed during my final year of college. Witnessing websites lacking in either design appeal or optimal performance sparked my desire to contribute to a more engaging and effective web experience for everyone. This passion, coupled with my lifelong love of coding, motivated me to embark on a self-directed learning journey.</p>
        </div>

        <div id="experience">
          <h3 className='text-4xl mt-10 mb-3 text-my-theme w-max'><a href="#experience">Experience</a></h3>
